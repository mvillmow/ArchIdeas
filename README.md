...
- `momora.md` — MoMoRA: Mixture of Models with Recurrence and Attention. Hierarchical MoM routing + recurrent state + gated output emission design doc (see also `research/research_4_6_mixture_of_models.md`).
