...
**Description:** A multi-agent architecture where multiple independently specialized models collaborate. See `research/research_4_6_mixture_of_models.md` for details.
